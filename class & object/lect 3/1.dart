void main() {
  ...
  for (int i = 0; i < b1.length; i++) {
    ...
    Bank b2 = Bank.fromMap(b1[i]);
    print("isactive:${b2.isActive}");
    print("balance:${b2.balance}");
    print("age:${b2.age}");
    print("Eye color:${b2.eyeColor}");
    print("Name:${b2.name}");
    print("Gender:${b2.gender}");
    print("company:${b2.company}");
    print("email:${b2.email}");
    print("phone:${b2.phone}");
    print("address:${b2.address}");
  }
}
...
class Bank {
  ...
  factory Bank.fromMap(Map m1) {
    ...
    Bank bank = Bank._temp(isActive, balance, age, eyeColor, name, gender,
